...
public class LongestSubstringWithKDistinctChars {
    ...
    public static void main(String[] args) {
        LongestSubstringWithKDistinctChars sw = new LongestSubstringWithKDistinctChars();
        System.out.println("Length of the longest substring: " + sw.findLength("araaci", 2));
        System.out.println("Length of the longest substring: " + sw.findLength("araaci", 1));
        System.out.println("Length of the longest substring: " + sw.findLength("cbbebi", 3));
    }
